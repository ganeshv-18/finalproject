...
export class ProductService {
 ...
 private Products_urls = "http://localhost:3000/app/dashboard/Products";
 private Products_find = "http://localhost:3000/app/dashboard/Products";
 private Products_add = "http://localhost:3000/app/dashboard/Products/add";
 private Products_update = "http://localhost:3000/app/dashboard/Products/update/";
